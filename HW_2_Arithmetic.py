...
result_mp_s_root = math.sqrt(math.pow(item_1,item_2))
...
result_no_division_loss = math.trunc(item_1 / item_2)
...
result_division_loss = math.fmod(item_1,item_2)
...
#  46. Присвоить остаток от деления.

item_3 = math.fmod(item_3,1)
...
# b_item_relult_division = b_item_t / b_item_f (На ноль делить нельзя)
